...
var ParserBase = (
  ...
  function() {
    ...
    ParserBase2.getSymbolRegex = function(props3) {
      var regexStr = props3.map(function(str) {
  ...
  function() {
    ...
    DateParser2.internalDateParse = function(value, parseOptions, num) {
      ...
      if (isNullOrUndefined(matches2)) {
        ...
        var props3 = Object.keys(parseOptions.evalposition);
        for (var _i = 0, props_1 = props3; _i < props_1.length; _i++) {
          var prop = props_1[_i];
...
var Ajax = (
  ...
  function() {
    ...
    Ajax2.prototype.getResponseHeader = function(key) {
      ...
      header2 = responseHeaders[key.toLowerCase()];
      return isNullOrUndefined(header2) ? null : header2;
    };
    return Ajax2;
  }()
);
...
function createElement(tagName, properties3) {
  var element = SVG_REG.test(tagName) ? document.createElementNS("http://www.w3.org/2000/svg", tagName) : document.createElement(tagName);
  if (typeof properties3 === "undefined") {
    return element;
  }
  element.innerHTML = properties3.innerHTML ? properties3.innerHTML : "";
  if (properties3.className !== void 0) {
    element.className = properties3.className;
  }
  if (properties3.id !== void 0) {
    element.id = properties3.id;
  }
  if (properties3.styles !== void 0) {
    element.setAttribute("style", properties3.styles);
  }
  if (properties3.attrs !== void 0) {
    attributes(element, properties3.attrs);
  }
  return element;
}
  ...
  function() {
    function LicenseValidator2(key) {
      ...
      this.npxManager = function() {
        var npxLicKey = "npxKeyReplacevbTJtMa2xbzDx46FhoGEgYeEjoSFgoaEgoyMjIxzhISNiIyNiIxzo6COUw==";
        function get() {
          return npxLicKey;
        }
        return {
  ...
  function(_super) {
    ...
    Droppable2.prototype.intOver = function(event, element) {
      if (!this.mouseOver) {
        ...
        this.trigger("over", { event, target: element, dragData: drag2 });
        this.mouseOver = true;
      }
    };
    ...
    Droppable2.prototype.intDrop = function(evt, element) {
      ...
      var area;
      if (isDrag) {
        area = this.isDropArea(evt, drag2.helper, element);
        if (this.accept) {
          accept = matches(drag2.helper, this.accept);
        }
      }
...
function SlashReplace(tempStr) {
  ...
  if (tempStr.match(DOUBLE_SLASH)) {
    ...
    tempStr = tempStr.replace(SINGLE_SLASH, double2);
  }
  return tempStr;
}
...
// node_modules/@syncfusion/ej2-vue-layouts/node_modules/@syncfusion/ej2-layouts/src/splitter/splitter.js
...
var PaneProperties = (
  /** @class */
  function(_super) {
    __extends7(PaneProperties2, _super);
...
var Splitter = (
  ...
  function(_super) {
    ...
    Splitter2.prototype.onMove = function(event) {
    ...
    Splitter2.prototype.compileElement = function(ele, val, prop) {
      ...
      if (!isNullOrUndefined(val.outerHTML)) {
        templateFn = compile2(val.outerHTML);
      } else {
        templateFn = compile2(val);
      }
      var templateFUN;
...
// node_modules/@syncfusion/ej2-vue-layouts/node_modules/@syncfusion/ej2-layouts/src/dashboard-layout/dashboard-layout.js
...
var DashboardLayout = (
  /** @class */
  function(_super) {
    __extends8(DashboardLayout2, _super);
    ...
    DashboardLayout2.prototype.templateParser = function(template) {
      if (template) {
        try {
          ...
          return compile2(this.enableHtmlSanitizer && typeof template === "string" ? sanitizedValue : template);
        }
      }
      return void 0;
    };
...
// node_modules/@syncfusion/ej2-vue-layouts/node_modules/@syncfusion/ej2-vue-base/src/component-base.js
...
var curVue = _interopRequireWildcard(vue_runtime_esm_bundler_exports);
  ...
  methods: {
    ...
    resolveComplexDirs: function(slots, tagObject, tagName) {
      ...
      var _loop_3 = function(childSlot2) {
        ...
        if (tagObject["" + tagName]) {
          ...
          tag = (this_3.tagNameMapper["" + tag] ? this_3.tagNameMapper["" + tag] : tag).replace("e-ribbon-", "").replace("e-", "");
    ...
    resolveComplexInnerDirs: function(slots, tagObject, tagName) {
      ...
      for (var _i = 0, slot_3 = slot; _i < slot_3.length; _i++) {
        ...
        var isSpreadsheet = this.ej2Instances.getModuleName().toLowerCase() == "spreadsheet";
        ...
        if (childSlot.children) {
          ...
          if (/[s]\b/.test(tag) || slot.length > 1) {
            ...
            } else if (innerDirValues && !(isRibbon && innerDirValues.hasOwnProperty("collections")) && !(isSpreadsheet && innerDirValues.hasOwnProperty("cells") && childSlot.props)) {
        ...
        if (slot.length > 1 && childSlot.props) {
          if (isRibbon && innerDirValues && innerDirValues.hasOwnProperty("collections") || isSpreadsheet && innerDirValues && innerDirValues.hasOwnProperty("cells")) {
    ...
    getDirectiveValues: function(tagDirectives, tagMapper, tagNameMapper) {
      ...
      if (tagDirectives) {
        for (var _i = 0, tagDirectives_1 = tagDirectives; _i < tagDirectives_1.length; _i++) {
          ...
          if (tagDirective.componentOptions && tagDirective.componentOptions.children && this.getTagName(tagDirective.componentOptions) || tagDirective.tag === "e-seriescollection" && tagDirective.children) {
     ...
     */
    getCamelCaseProps: function(props3) {
      var retProps = {};
...
// node_modules/@syncfusion/ej2-vue-layouts/node_modules/@syncfusion/ej2-vue-base/src/template.js
...
// node_modules/@syncfusion/ej2-vue-layouts/src/splitter/panesettings.directive.js
...
// node_modules/@syncfusion/ej2-vue-layouts/src/splitter/splitter.component.js
...
// node_modules/@syncfusion/ej2-vue-layouts/src/dashboard-layout/panels.directive.js
...
// node_modules/@syncfusion/ej2-vue-layouts/src/dashboard-layout/dashboardlayout.component.js
...
var DashboardLayoutComponent = vueDefineComponent({
  ...
  methods: {
    ...
    addPanel: function(panel2) {
      return this.ej2Instances.addPanel(panel2);
    },
    ...
    updatePanel: function(panel2) {
      return this.ej2Instances.updatePanel(panel2);
    }
  }
});
...
//# sourceMappingURL=@syncfusion_ej2-vue-layouts.js.map
