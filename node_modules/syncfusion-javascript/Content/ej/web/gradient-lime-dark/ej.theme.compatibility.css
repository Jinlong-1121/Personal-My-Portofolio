...
.e-js.e-pivotgrid .e-memberDescendingIcon:hover,
.e-js.e-pivotgrid .e-memberAscendingIcon:hover {
  background-color: linear-gradient(to bottom, #4a5038 0%, #404a22 100%);
}
...
.e-js.e-ganttchart .e-gantt-childtaskbar.e-gantt-unscheduletaskbar {
  background-color: rgba(206, 226, 146, 0.6);
  background: linear-gradient(to right, rgba(206, 226, 146, 0.2), #cee292 30%, #cee292 70%, #cee292 70%, rgba(206, 226, 146, 0.2) 100%);
  -ms-filter: "progid:DXImageTransform.Microsoft.Alpha(Opacity=40)";
}
