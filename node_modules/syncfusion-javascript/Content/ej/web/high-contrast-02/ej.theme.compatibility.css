...
.e-js.e-ganttchart .e-gantt-childtaskbar.e-gantt-unscheduletaskbar {
  background-color: rgba(0, 0, 255, 0.6);
  background: linear-gradient(to right, rgba(0, 0, 255, 0.2), blue 30%, blue 70%, blue 70%, rgba(0, 0, 255, 0.2) 100%);
  -ms-filter: "progid:DXImageTransform.Microsoft.Alpha(Opacity=40)";
}
...
.e-js.e-ganttchart .e-manualchildtaskbar.e-gantt-unscheduletaskbar {
  background-color: #3fb9a5;
  background: linear-gradient(to right, rgba(63, 185, 165, 0.2), #73f8e2 30%, #73f8e2 70%, #73f8e2 70%, rgba(63, 185, 165, 0.2) 100%);
  -ms-filter: "progid:DXImageTransform.Microsoft.Alpha(Opacity=40)";
}
