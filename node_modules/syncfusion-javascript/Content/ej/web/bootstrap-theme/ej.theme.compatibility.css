...
.e-js.e-ganttchart .e-gantt-childtaskbar.e-gantt-unscheduletaskbar {
  background-color: #3277b2;
  background: linear-gradient(to right, rgba(50, 119, 178, 0.2), #3277b2 30%, #3277b2 70%, #3277b2 70%, rgba(50, 119, 178, 0.2) 100%);
  -ms-filter: "progid:DXImageTransform.Microsoft.Alpha(Opacity=40)";
}
...
.e-js.e-ganttchart .e-manualchildtaskbar.e-gantt-unscheduletaskbar {
  background-color: #9dd9dd;
  background: linear-gradient(to right, rgba(157, 217, 221, 0.2), #42c0bd 30%, #42c0bd 70%, #42c0bd 70%, rgba(157, 217, 221, 0.2) 100%);
  -ms-filter: "progid:DXImageTransform.Microsoft.Alpha(Opacity=40)";
}
