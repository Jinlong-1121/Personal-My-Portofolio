...
.e-js.e-ganttchart .e-gantt-childtaskbar.e-gantt-unscheduletaskbar {
  background-color: rgba(0, 128, 0, 0.6);
  background: linear-gradient(to right, rgba(0, 128, 0, 0.2), green 30%, green 70%, green 70%, rgba(0, 128, 0, 0.2) 100%);
  -ms-filter: "progid:DXImageTransform.Microsoft.Alpha(Opacity=40)";
}
...
.e-js.e-ganttchart .e-manualchildtaskbar.e-gantt-unscheduletaskbar {
  background-color: #0fa78e;
  background: linear-gradient(to right, rgba(15, 167, 142, 0.2), #16f3cf 30%, #16f3cf 70%, #16f3cf 70%, rgba(15, 167, 142, 0.2) 100%);
  -ms-filter: "progid:DXImageTransform.Microsoft.Alpha(Opacity=40)";
}
.e-js.e-ganttchart .e-milestone-top.e-unscheduletaskbar {
  border-bottom-color: rgba(219, 219, 0, 0.6);
}
.e-js.e-ganttchart .e-milestone-bottom.e-unscheduletaskbar {
  border-top-color: rgba(219, 219, 0, 0.6);
}
