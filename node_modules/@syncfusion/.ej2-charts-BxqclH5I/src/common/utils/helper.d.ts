...
/** @private */
export declare function textTrim(maxWidth: number, text: string, font: FontModel, themeFontStyle?: FontModel): string;
/** @private */
 ...
 */
export declare function getTitle(title: string, style: FontModel, width: number, themeFontStyle?: FontModel): string[];
/**
 ...
 */
export declare function textWrap(currentLabel: string, maximumWidth: number, font: FontModel, wrapAnyWhere?: boolean, clip?: boolean, themeFontStyle?: FontModel): string[];
/**
