...
var CellRenderer = /** @class */ (function () {
    ...
    CellRenderer.prototype.update = function (args) {
        ...
        this.parent.refreshNode(args.td, { type: formatArgs.type, result: formatArgs.formattedText, curSymbol: formatArgs.curSymbol, isRightAlign: formatArgs.isRightAlign, value: ((formatArgs.value || formatArgs.value === 0) ? formatArgs.value : ''), isRowFill: formatArgs.isRowFill, rowIndex: args.rowIdx, colIndex: args.colIdx });
        var style = {};
        if (args.cell) {
            if (args.cell.style) {
