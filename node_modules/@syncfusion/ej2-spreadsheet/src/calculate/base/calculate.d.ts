...
export declare class Calculate extends Base<HTMLElement> implements INotifyPropertyChanged {
     ...
     */
    getValueFromArg(arg: string, isUnique?: boolean, isIfError?: boolean): string;
     ...
     */
    valueChanged(grid: string, changeArgs: ValueChangedArgs, isCalculate?: boolean, usedRangeCol?: number[], refresh?: boolean, sheetName?: string, isRandomFormula?: boolean, randomFormulaRefreshing?: boolean): void;
    /**
     * @hidden
    ...
    refresh(cellRef: string, uniqueCell?: string, dependentCell?: string[], isRandomFormula?: boolean): void;
}
/** @hidden */
