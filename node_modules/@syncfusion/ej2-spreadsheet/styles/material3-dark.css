...
.e-bigger .e-chart-menu.e-menu-wrapper ul.e-ul .e-menu-item .e-menu-icon.e-bar,
.e-bigger .e-chart-type-menu.e-menu-wrapper ul.e-ul .e-menu-item .e-menu-icon.e-bar {
  font-size: 30px;
  left: -4px;
  margin-right: 0;
  position: relative;
...
.e-spreadsheet .e-findtool-dlg.e-rtl .e-find-toolbar .e-toolbar-items:not(.e-tbar-pos):not(.e-toolbar-multirow) .e-toolbar-item:first-child {
  margin-left: 0;
  margin-right: 16px;
}
.e-spreadsheet .e-findtool-dlg.e-rtl .e-find-toolbar .e-toolbar-items:first-child:not(.e-toolbar-multirow) > .e-toolbar-item:last-child {
  margin-left: 16px;
  margin-right: 0;
}
...
.e-spreadsheet .e-sheet-tab.e-tab .e-tab-header .e-toolbar-items .e-toolbar-item.e-active {
  background: linear-gradient(0deg, rgba(var(--color-sf-primary), 0.05), rgba(var(--color-sf-primary), 0.05)), rgba(var(--color-sf-surface));
}
...
.e-spreadsheet .e-ribbon .e-toolbar .e-btn:not(.e-tbar-btn):not(.e-split-btn) {
  border: none;
}
...
.e-spreadsheet .e-conditionalformatting-dlg .e-cfsub {
  margin-bottom: 12px;
}
...
.e-spreadsheet .e-find-dlg.e-dialog .e-dlg-header-content {
  padding-bottom: 4px;
}
...
.e-spreadsheet .e-btn.e-icon-btn.e-filter-btn {
  ...
  border-color: rgba(var(--color-sf-spreadsheet-gridline));
  box-shadow: none;
  width: 22px;
}
...
.e-dropdown-popup.e-spreadsheet-color-popup .e-container .e-custom-palette + .e-switch-ctrl-btn {
...
.e-bigger .e-spreadsheet .e-ribbon .e-toolbar .e-btn:not(.e-tbar-btn).e-chart-ddb,
.e-bigger.e-spreadsheet .e-ribbon .e-toolbar .e-btn:not(.e-tbar-btn).e-chart-ddb {
  padding-left: 26px;
}
...
.e-bigger .e-spreadsheet .e-ribbon .e-toolbar .e-toolbar-item .e-btn .e-chart-icon, .e-bigger .e-spreadsheet .e-ribbon .e-toolbar .e-toolbar-item .e-btn .e-chart-type-icon,
.e-bigger.e-spreadsheet .e-ribbon .e-toolbar .e-toolbar-item .e-btn .e-chart-icon,
.e-bigger.e-spreadsheet .e-ribbon .e-toolbar .e-toolbar-item .e-btn .e-chart-type-icon {
  font-size: 36px !important; /* stylelint-disable-line declaration-no-important */
  margin-right: 0;
  padding: 0;
  width: 36px;
}
.e-bigger .e-spreadsheet .e-ribbon .e-toolbar .e-toolbar-item .e-btn.e-split-colorpicker .e-icons.e-btn-icon:not(.e-caret).e-font-color,
.e-bigger.e-spreadsheet .e-ribbon .e-toolbar .e-toolbar-item .e-btn.e-split-colorpicker .e-icons.e-btn-icon:not(.e-caret).e-font-color {
  font-size: 16px;
}
.e-bigger .e-spreadsheet .e-ribbon .e-toolbar .e-toolbar-item .e-btn.e-split-colorpicker .e-icons.e-btn-icon:not(.e-caret).e-fill-color,
.e-bigger.e-spreadsheet .e-ribbon .e-toolbar .e-toolbar-item .e-btn.e-split-colorpicker .e-icons.e-btn-icon:not(.e-caret).e-fill-color {
  font-size: 18px;
}
...
.e-bigger .e-spreadsheet .e-add-sheet-tab, .e-bigger .e-spreadsheet .e-sheets-list,
.e-bigger.e-spreadsheet .e-add-sheet-tab,
.e-bigger.e-spreadsheet .e-sheets-list {
  margin-left: 9px;
}
...
.e-bigger .e-spreadsheet .e-dlg-content,
.e-bigger.e-spreadsheet .e-dlg-content {
  margin-top: 0;
}
...
.e-bigger .e-spreadsheet .e-validation-dlg .e-cellrange,
.e-bigger.e-spreadsheet .e-validation-dlg .e-cellrange {
  margin-bottom: 8px;
}
.e-bigger .e-spreadsheet .e-validation-dlg .e-allowdata .e-allow,
.e-bigger.e-spreadsheet .e-validation-dlg .e-allowdata .e-allow {
  margin-bottom: 12px;
}
.e-bigger .e-spreadsheet .e-validation-dlg .e-values,
.e-bigger.e-spreadsheet .e-validation-dlg .e-values {
  margin-bottom: 8px;
}
...
.e-bigger .e-spreadsheet .e-find-dlg.e-dialog .e-dlg-header-content,
.e-bigger.e-spreadsheet .e-find-dlg.e-dialog .e-dlg-header-content {
  padding-bottom: 8px;
}
...
.e-bigger .e-spreadsheet .e-datavalidation-dlg .e-validation-dlg .e-cellrange,
.e-bigger.e-spreadsheet .e-datavalidation-dlg .e-validation-dlg .e-cellrange {
  padding-top: 4px;
}
...
.e-spreadsheet .e-spreadsheet-function-dlg.e-dialog .e-dlg-content .e-category-content {
  color: rgba(var(--color-sf-on-surface-variant));
}
.e-spreadsheet .e-spreadsheet-function-dlg.e-dialog .e-dlg-content .e-description-content {
  color: rgba(var(--color-sf-on-surface-variant));
}
.e-spreadsheet .e-protect-dlg.e-dialog .e-sheet-password-content, .e-spreadsheet .e-protect-dlg.e-dialog .e-protect-content {
  color: rgba(var(--color-sf-on-surface-variant));
}
.e-spreadsheet .e-reenterpwd-dlg.e-dialog .e-dlg-content .e-reenterpwd-alert-span {
  color: rgba(var(--color-sf-error));
...
.e-spreadsheet .e-datavalidation-dlg .e-validation-dlg .e-header {
  color: rgba(var(--color-sf-on-surface-variant));
}
.e-spreadsheet .e-dlg-content .e-custom-dialog .e-custom-sample, .e-spreadsheet .e-conditionalformatting-dlg .e-dlg-content .e-header {
  color: rgba(var(--color-sf-on-surface-variant));
}
.e-spreadsheet .e-sort-dialog .e-sort-listwrapper .text {
  color: rgba(var(--color-sf-on-surface-variant));
}
.e-spreadsheet .e-find-dlg.e-dialog p.e-header {
  color: rgba(var(--color-sf-on-surface-variant));
...
.e-spreadsheet .e-sheet-tab-panel .e-btn.e-flat.e-active {
  border-radius: 8px;
...
.e-spreadsheet .e-ribbon .e-toolbar .e-btn:not(.e-tbar-btn):focus.e-active {
  background: rgba(var(--color-sf-primary-container));
  border-color: transparent;
  border-radius: 4px;
}
.e-spreadsheet .e-ribbon .e-toolbar .e-btn:not(.e-tbar-btn):focus-visible.e-active {
  box-shadow: 0 0 0 1px #000000, 0 0 0 3px #ffffff;
}
.e-spreadsheet .e-ribbon .e-toolbar .e-btn:not(.e-tbar-btn):focus:not(.e-active) {
  border-radius: 4px;
}
...
.e-spreadsheet .e-ribbon .e-toolbar .e-btn:not(:focus):not(.e-tbar-btn):hover.e-active {
  background: rgba(var(--color-sf-primary-container));
  border-color: transparent;
  border-radius: 4px;
}
...
.e-spreadsheet .e-cell {
  background-color: rgba(var(--color-sf-white));
  border-bottom-color: rgba(var(--color-sf-spreadsheet-gridline));
  color: rgba(var(--color-sf-black));
}
...
.e-spreadsheet .e-sheet-panel:not(.e-rtl) .e-cell {
  border-right-color: rgba(var(--color-sf-spreadsheet-gridline));
}
...
.e-spreadsheet .e-sheet-panel.e-rtl .e-cell {
  border-left-color: rgba(var(--color-sf-spreadsheet-gridline));
}
...
.e-spreadsheet .e-range-indicator div.e-left,
.e-spreadsheet .e-formularef-indicator div.e-left {
  background: url("data:image/gif;base64,") repeat-y left top;
}
.e-spreadsheet .e-copy-indicator div.e-right,
.e-spreadsheet .e-range-indicator div.e-right,
.e-spreadsheet .e-formularef-indicator div.e-right {
  background: url("data:image/gif;base64,") repeat-y right top;
}
...
.e-spreadsheet .e-selection {
  background-color: rgba(var(--color-sf-primary), 0.12);
  border-color: rgba(var(--color-sf-primary));
}
...
.e-spreadsheet .e-frozen-column {
  background-color: rgba(var(--color-sf-spreadsheet-gridline));
  border-right: 3px solid rgba(var(--color-sf-spreadsheet-gridline));
}
.e-spreadsheet .e-frozen-row {
  border-bottom: 1px solid rgba(var(--color-sf-spreadsheet-gridline));
  border-bottom: 3px solid rgba(var(--color-sf-spreadsheet-gridline));
}
.e-spreadsheet .e-validation-list {
...
.e-spreadsheet .e-sheet-panel:not(.e-rtl) .e-cell.e-rcborderbottom {
  border-bottom: 1px dashed rgba(var(--color-sf-error));
}
.e-spreadsheet .e-sheet-panel:not(.e-rtl) .e-cell.e-rcborderright {
  border-right: 1px dashed rgba(var(--color-sf-error));
}
