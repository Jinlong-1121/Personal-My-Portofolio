...
.e-spreadsheet .e-open-dlg.e-dialog .e-dlg-content .e-input-group-icon {
  padding-left: 4px;
  padding-right: 4px;
}
...
.e-spreadsheet .e-sheet-tab-panel .e-btn.e-flat.e-icon-btn:hover:not(.e-disabled) .e-btn-icon {
  color: #fff;
}
...
.e-spreadsheet .e-ribbon.e-collapsed .e-tab .e-tab-header:not(.e-vertical)::before {
  border-width: 0;
}
...
.e-spreadsheet .e-ribbon .e-menu-wrapper ul {
  background-color: transparent;
}