...
.e-spreadsheet .e-btn.e-icon-btn.e-filter-btn {
  ...
  border-color: rgba(var(--color-sf-surface-variant));
  box-shadow: none;
  width: 22px;
}
...
.e-spreadsheet .e-cell {
  background-color: rgba(var(--color-sf-white));
  border-bottom-color: rgba(var(--color-sf-surface-variant));
  color: rgba(var(--color-sf-black));
}
...
.e-spreadsheet .e-sheet-panel:not(.e-rtl) .e-cell {
  border-right-color: rgba(var(--color-sf-surface-variant));
}
...
.e-spreadsheet .e-sheet-panel.e-rtl .e-cell {
  border-left-color: rgba(var(--color-sf-surface-variant));
}
...
.e-spreadsheet .e-frozen-column {
  ...
  border-right: 3px solid rgba(var(--color-sf-surface-variant));
}
.e-spreadsheet .e-frozen-row {
  border-bottom: 1px solid rgba(var(--color-sf-surface-variant));
  border-bottom: 3px solid rgba(var(--color-sf-surface-variant));
}
.e-spreadsheet .e-validation-list {
