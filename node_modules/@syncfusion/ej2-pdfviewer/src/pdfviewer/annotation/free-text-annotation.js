    ...
    FreeTextAnnotation.prototype.saveFreeTextAnnotations = function () {
        ...
        if (storeObject && !this.pdfViewer.annotationSettings.skipDownload) {
            ...
            for (var i = 0; i < annotationCollection.length; i++) {
                ...
                for (var k = 0; pageAnnotationObject.annotations.length > k; k++) {
                    if (!isNullOrUndefined(pageAnnotationObject.annotations[k])) {
                        var noOfLines = pageAnnotationObject.annotations[k].dynamicText.split("\n").length;
                        var newHeight = noOfLines * pageAnnotationObject.annotations[k].fontSize * this.lineGap;
                        if (pageAnnotationObject.annotations[k].bounds.height < newHeight) {
                            pageAnnotationObject.annotations[k].bounds.height = newHeight;
                        }
                    }
                }
