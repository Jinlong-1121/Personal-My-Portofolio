...
/*! component's theme wise override definitions and variables */ /*! component's theme wise override definitions and variables */ /*! component's theme wise override definitions and variables */ /*! Bootstrap theme definition's */
...
.e-dropdown-popup.e-ribbon-dropdown-group-button.e-ribbon-group-button-overflow-popup .e-btn-group {
  -ms-flex-direction: column;
      flex-direction: column;
}
...
.e-bigger.e-ribbon-menu.e-menu-wrapper ul.e-ul .e-menu-item.e-blankicon {
  padding-left: 41px !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-bigger .e-ribbon-backstage-menu.e-menu-wrapper ul.e-vertical .e-menu-item:not(.e-separator),
.e-bigger.e-ribbon-backstage-menu.e-menu-wrapper ul.e-vertical .e-menu-item:not(.e-separator),
.e-bigger .e-ribbon-backstage-menu.e-menu-wrapper ul.e-ul .e-menu-item:not(.e-separator),
.e-bigger.e-ribbon-backstage-menu.e-menu-wrapper ul.e-ul .e-menu-item:not(.e-separator) {
  height: 52px;
}
.e-bigger .e-ribbon-backstage-menu.e-menu-wrapper ul.e-vertical .e-menu-item:not(.e-separator) .e-menu-icon,
.e-bigger.e-ribbon-backstage-menu.e-menu-wrapper ul.e-vertical .e-menu-item:not(.e-separator) .e-menu-icon,
.e-bigger .e-ribbon-backstage-menu.e-menu-wrapper ul.e-ul .e-menu-item:not(.e-separator) .e-menu-icon,
.e-bigger.e-ribbon-backstage-menu.e-menu-wrapper ul.e-ul .e-menu-item:not(.e-separator) .e-menu-icon {
  font-size: 20px;
  line-height: 20px;
  padding: 18px 16px;
}
.e-bigger .e-ribbon-backstage-menu.e-menu-wrapper ul.e-vertical .e-menu-item:not(.e-separator).e-blankicon,
.e-bigger.e-ribbon-backstage-menu.e-menu-wrapper ul.e-vertical .e-menu-item:not(.e-separator).e-blankicon,
.e-bigger .e-ribbon-backstage-menu.e-menu-wrapper ul.e-ul .e-menu-item:not(.e-separator).e-blankicon,
.e-bigger.e-ribbon-backstage-menu.e-menu-wrapper ul.e-ul .e-menu-item:not(.e-separator).e-blankicon {
  padding-left: 52px !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-ribbon-group-overflow-ddb .e-ribbon-overflow-target .e-ribbon-of-tab {
  box-shadow: 0 6px 12px rgba(0, 0, 0, 0.175);
}
...
.e-bigger .e-ribbon-group-overflow-ddb.e-dropdown-popup {
  background: #f8f8f8;
  border-color: unset;
}
