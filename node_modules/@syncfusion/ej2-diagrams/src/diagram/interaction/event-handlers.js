...
import { Native, Node, Lane, Phase } from '../objects/node';
...
var DiagramEventHandler = /** @class */ (function () {
            ...
            if (((this.tool instanceof PolygonDrawingTool || this.tool instanceof PolyLineDrawingTool)
                ...
                if (this.diagram.selectedItems.canToggleSelection && prevSelectedNode
                    ...
                    for (var i = 0; i < prevSelectedNode.length; i++) {
                        if (prevSelectedNode[parseInt(i.toString(), 10)].id !== this.diagram.selectedItems.nodes[parseInt(i.toString(), 10)].id) {
    ...
    DiagramEventHandler.prototype.mouseMoveExtend = function (e, obj) {
        ...
        if (this.tool instanceof ConnectTool) {
            this.diagram.updatePortVisibility((this.hoverElement instanceof Node || this.hoverElement instanceof Connector) ? this.hoverElement : this.hoverNode, PortVisibility.Connect | PortVisibility.Hover, isNode);
        }
            ...
            if (Point.equals(this.currentPosition, this.prevPosition) === false || this.inAction) {
                if (this.isMouseDown === false || force) {
                    ...
                    if (obj !== null) {
                        ...
                        if (tooltipTarget !== this.hoverElement) {
                            ...
                            if (portElement instanceof PathElement) {
                                ...
                                if ((portTarget instanceof PointPort || portTarget instanceof PathPort) && this.hoverElement.constraints & PortConstraints.ToolTip) {
                    ...
                    if (!(this.hoverElement && (!(this.tool instanceof ZoomPanTool))
                        ...
                        (this.diagram.selectedItems.nodes.length === 0 || !isSelected(this.diagram, this.hoverElement))) && (!(this.hoverElement instanceof Connector))) {
                        isNode = true;
                    }
                    if (!(this.hoverElement && (!(this.tool instanceof ZoomPanTool))
                        && (obj instanceof Connector) &&
                        (this.diagram.selectedItems.connectors.length === 0 || !isSelected(this.diagram, this.hoverElement))) && (!(this.hoverElement instanceof Node))) {
                        isNode = true;
                    }
    ...
    DiagramEventHandler.prototype.getContent = function () {
        var isPrivateTooltip = ((this.hoverElement instanceof Node) && this.hoverElement.constraints & NodeConstraints.Tooltip) ||
            ...
            ((this.hoverElement instanceof PointPort || this.hoverElement instanceof PathPort) && this.hoverElement.constraints & PortConstraints.ToolTip);
                    ...
                    if (this.diagram.selectedObject.helperObject && (this.tool instanceof MoveTool || this.tool instanceof ResizeTool)) {
                        ...
                        if (this.diagram.selectedItems.canToggleSelection) {
                            ...
                            for (var i = 0; i < prevSelectedNodes.length; i++) {
                                if ((prevSelectedNodes.length > 1 && currSelectedNodes[0].id == prevSelectedNodes[parseInt(i.toString(), 10)].id) ||
                                    prevSelectedConnectors.length > 0) {
                                    isMultiSelect = true;
                                }
                            }
    ...
    ObjectFinder.prototype.findObjectUnderMouse = function (diagram, objects, action, inAction, eventArg, position, source) {
        ...
        if (objects.length !== 0) {
            ...
            if ((action === 'ConnectorSourceEnd' && source || action === 'PortDraw') ||
                ...
                for (var i = objects.length - 1; i >= 0; i--) {
                    inPort = getInOutConnectPorts(objects[parseInt(i.toString(), 10)], true);
                    if ((objects[parseInt(i.toString(), 10)] instanceof Node || objects[parseInt(i.toString(), 10)] instanceof Connector) && (canInConnect(objects[parseInt(i.toString(), 10)]) || (canPortInConnect(inPort)))) {
                        actualTarget = objects[parseInt(i.toString(), 10)];
                        actualTarget = this.isTarget(actualTarget, diagram, action);
                        eventArg.actualObject = actualTarget;
                        return actualTarget;
