...
var SfdtReader = /** @class */ (function () {
    ...
    SfdtReader.prototype.parseBody = function (data, blocks, container, isSectionBreak, contentControlProperties, styles) {
        if (!isNullOrUndefined(data)) {
            for (var i = 0; i < data.length; i++) {
                var block = data[i];
                            ...
                            if (this.isPaste && styles) {
                                for (var j = 0; j < styles.length; j++) {
                                    if (styles[j][nameProperty[this.keywordIndex]] === styleName) {
                                        ...
                                        if (fontColor[fontColorProperty[this.keywordIndex]] !== styleObj.characterFormat.fontColor) {
                                            var charFormat = new WCharacterFormat();
            ...
            if (inline.hasOwnProperty(textProperty[this.keywordIndex]) || inline.hasOwnProperty(breakClearTypeProperty[this.keywordIndex])) {
                ...
                if (this.documentHelper.owner.parser.isPaste && !(this.isCutPerformed)) {
                    if (!isNullOrUndefined(inline[revisionIdsProperty[this.keywordIndex]])) {
                        for (var j = 0; j < inline[revisionIdsProperty[this.keywordIndex]].length; j++) {
                ...
                this.parseBody(inline[blocksProperty[this.keywordIndex]], footnoteElement.bodyWidget.childWidgets, footnoteElement.bodyWidget, false);
                ...
                var image = new ImageElementBox(HelperMethods.parseBoolValue(inline[isInlineImageProperty[this.keywordIndex]]));
                ...
                var imageString = HelperMethods.formatClippedString(inline[imageStringProperty[this.keywordIndex]]).formatClippedString;
                ...
                var imgStrValue = parseInt(inline[imageStringProperty[this.keywordIndex]]);
                ...
                if (inline.hasOwnProperty(editableRangeStartProperty[this.keywordIndex])) {
                    ...
                    if (this.editableRanges.containsKey(inline[editRangeIdProperty[this.keywordIndex]])) {
                        var start = this.editableRanges.get(inline[editRangeIdProperty[this.keywordIndex]]);
                ...
                var commentID = inline[commentIdProperty[this.keywordIndex]];
                ...
                if (inline.hasOwnProperty(textFrameProperty[this.keywordIndex])) {
                    ...
                    this.parseBody(inline[textFrameProperty[this.keywordIndex]][blocksProperty[this.keywordIndex]], textFrame.childWidgets, textFrame);
