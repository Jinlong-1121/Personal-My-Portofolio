import { Animation, Browser, ChildProperty, Collection, Complex, Component, Event, EventHandler, NotifyPropertyChanges, Property, animationMode, createElement, isNullOrUndefined, remove } from '@syncfusion/ej2-base';
 ...
 * class for tooltip.
 */
var ProgressTooltip = /** @__PURE__ @class */ (function () {
    /**
...
var Linear = /** @__PURE__ @class */ (function () {
    ...
    Linear.prototype.renderLinearBuffer = function (progress) {
        ...
        var stroke = progress.secondaryProgressColor ? progress.secondaryProgressColor : this.checkingLinearProgressColor();
        if (progress.cornerRadius === 'Round4px') {
            if (progress.segmentCount > 1) {
